...
const columns = [
  ...
  },
  {
    ...
    links: ['docs', 'changelog', 'status', 'terms', 'privacy']
  }
]
</script>
...
<template>
  <footer class="bg-slate-950 text-slate-400">
    <div class="container-custom py-16">
      <!-- Top row -->
      <div class="grid grid-cols-2 md:grid-cols-4 gap-10 lg:gap-16 pb-12 border-b border-slate-800">
        <!-- Brand -->
        <div class="col-span-2 md:col-span-1">
          <div class="flex items-center gap-2 mb-4">
            ...
            <span class="text-lg font-bold text-white tracking-tight">VoltWise</span>
          </div>
        ...
        <div v-for="col in columns" :key="col.titleKey">
          <h4 class="text-sm font-semibold text-white mb-4">{{ t(col.titleKey) }}</h4>
      ...
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8">
        ...
        <div class="flex items-center gap-1 text-sm">
          <span class="w-2 h-2 rounded-full bg-volt-500 inline-block animate-pulse-slow" />
